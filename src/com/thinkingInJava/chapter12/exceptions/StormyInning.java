...
//derived from the case-class exceptions.
...
public class StormyInning extends Inning implements Storm {
    ...
    //public void event() throws RainedOut{ }
    //If the method doesn't already exits int the base class,the exception is ok:
    public void rainHard() throws RainedOut{ }
    ...
    public static void main(String[] args){
        ...
        try{
            ...
            i.atBat();
            //You must catch the exceptions form the base-class version of the method.
        }catch(Strike e){
