...
public class Demotion {
    ...
    void f4(char x){System.out.println("f3(char)");}
    void f4(byte x){System.out.println("f3(byte)");}
    void f4(short x){System.out.println("f3(short)");}
    void f4(int x){System.out.println("f3(int)");}

    void f5(char x){System.out.println("f3(char)");}
    void f5(byte x){System.out.println("f3(byte)");}
    void f5(short x){System.out.println("f3(short)");}
